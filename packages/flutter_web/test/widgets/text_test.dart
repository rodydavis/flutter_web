...
void main() {
  ...
  testWidgets('Text respects textScaleFactor with default font size',
    ...
    await tester.pumpWidget(const Center(
        child: Text('Hello',
            textScaleFactor: 1.5, textDirection: TextDirection.ltr)));
  ...
  testWidgets('semanticsLabel can override text label',
    ...
    await tester.pumpWidget(const Text('\$\$',
        semanticsLabel: 'Double dollars', textDirection: TextDirection.ltr));
  ...
  testWidgets('recognizers split semantic node - bidi',
    ...
    await tester.pumpWidget(RichText(
      text: TextSpan(
        ...
        children: <TextSpan>[
          ...
          TextSpan(
              text: 'SIR', recognizer: TapGestureRecognizer()..onTap = () {}),
        ...
        TestSemantics.rootChild(
          ...
          children: <TestSemantics>[
            TestSemantics(
              ...
              label: 'hello world ',
              textDirection:
                  TextDirection.ltr, // text direction is declared as LTR.
            ),
            TestSemantics(
              rect: Rect.fromLTRB(150.0, -4.0, 200.0, 18.0),
              label: 'RIS',
              textDirection: TextDirection
                  .rtl, // in the last string we switched to RTL using RLE.
              actions: <SemanticsAction>[
                SemanticsAction.tap,
              ],
            ),
    ...
    expect(semantics,
        hasSemantics(expectedSemantics, ignoreTransform: true, ignoreId: true));
    semantics.dispose();
  },
      skip:
          true); // TODO(jonahwilliams): correct once https://github.com/flutter/flutter/issues/20891 is resolved.
}
