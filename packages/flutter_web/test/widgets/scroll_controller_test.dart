...
void main() {
  ...
  testWidgets('keepScrollOffset', (WidgetTester tester) async {
    ...
    expect(tester.getTopLeft(find.widgetWithText(Container, 'Item 2')),
        Offset.zero);

    controller.jumpTo(2000.0);
    await tester.pump();
    expect(tester.getTopLeft(find.widgetWithText(Container, 'Item 20')),
        Offset.zero);
    ...
    expect(tester.getTopLeft(find.widgetWithText(Container, 'Item 1')),
        Offset.zero);
  });
}
