...
void main() {
  test('Image sizing', () {
    ...
    layout(image,
        constraints: const BoxConstraints(
            minWidth: 5.0, minHeight: 30.0, maxWidth: 100.0, maxHeight: 100.0));
    ...
    layout(image,
        constraints: const BoxConstraints(
            minWidth: 50.0, minHeight: 5.0, maxWidth: 75.0, maxHeight: 75.0));
    ...
    layout(image,
        constraints: const BoxConstraints(
            minWidth: 5.0, minHeight: 5.0, maxWidth: 100.0, maxHeight: 100.0));
    ...
    layout(image,
        constraints: const BoxConstraints(
            minWidth: 5.0, minHeight: 5.0, maxWidth: 16.0, maxHeight: 16.0));
    ...
    layout(image,
        constraints: const BoxConstraints(
            minWidth: 4.0, minHeight: 4.0, maxWidth: 8.0, maxHeight: 8.0));
    expect(image.size.width, equals(8.0));
    expect(image.size.height, equals(8.0));
  ...
  test('Null image sizing', () {
    ...
    layout(image,
        constraints: const BoxConstraints(
            minWidth: 25.0, minHeight: 25.0, maxWidth: 75.0, maxHeight: 75.0));
