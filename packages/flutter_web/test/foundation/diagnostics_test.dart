...
void validateNodeJsonSerializationHelper(
  ...
  final String valueToString = node is DiagnosticsProperty
      ? node.valueToString()
      : node.value.toString();
...
void validateIterablePropertyJsonSerialization(
  ...
  if (property.value != null) {
    ...
    final List<String> expectedValues =
        property.value.map<String>((Object value) => value.toString()).toList();
...
void main() {
  ...
  test('object property test', () {
    ...
    final DiagnosticsProperty<Rect> hideName = DiagnosticsProperty<Rect>(
        'name', rect,
        showName: false, level: DiagnosticLevel.warning);
