...
class TestServiceExtensionsBinding extends BindingBase
  ...
  Future<void> doFrame() async {
    ...
    if (ui.window.onBeginFrame != null) ui.window.onBeginFrame(Duration.zero);
    await flushMicrotasks();
    if (ui.window.onDrawFrame != null) ui.window.onDrawFrame();
  }
...
void main() {
  ...
  test('Service extensions - debugDumpApp', () async {
    ...
    expect(console, <String>[
      'TestServiceExtensionsBinding - CHECKED MODE',
  ...
  test('Service extensions - evict', () async {
    ...
    completed = false;
    BinaryMessages.setMockMessageHandler('flutter/assets',
  ...
  test('Service extensions - timeDilation', () async {
    ...
    expect(
        result, <String, String>{'timeDilation': ui.isWeb ? '100' : '100.0'});
  ...
  test('Service extensions - saveCompilationTrace', () async {
    Map<String, dynamic> result;
    result =
        await binding.testExtension('saveCompilationTrace', <String, String>{});
