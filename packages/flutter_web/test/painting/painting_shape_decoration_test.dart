...
void main() {
  ...
  test('ShapeDecoration constructor', () {
    ...
    expect(() => ShapeDecoration(gradient: nonconst(gradient), shape: null),
        throwsAssertionError);
    expect(
    ...
    expect(
      ShapeDecoration.fromBoxDecoration(BoxDecoration(
          shape: BoxShape.rectangle, border: Border.all(color: colorR))),
  ...
  test('ShapeDecoration.image RTL test', () {
    ...
    expect((Canvas canvas) {
      return painter.paint(
        ...
        paints
          ..drawImageRect(
              source: Rect.fromLTRB(0.0, 0.0, 100.0, 200.0),
