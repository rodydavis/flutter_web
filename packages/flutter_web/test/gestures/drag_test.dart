...
void main() {
  ...
  testGesture('Should recognize pan', (GestureTester tester) {
    ...
    // touch should give up when it hits kTouchSlop, which was 18.0
    // when this test was last updated.

    // move 10 horizontally and 10 vertically which is 14 total
    tester.route(pointer.move(const Offset(20.0, 20.0)));
    expect(didStartPan, isFalse); // 14 < 18
    // move 10 horizontally and 20 vertically which is 22 total
  ...
  testGesture('Drag details', (GestureTester tester) {
    ...
    expect(new DragUpdateDetails(globalPosition: Offset.zero),
