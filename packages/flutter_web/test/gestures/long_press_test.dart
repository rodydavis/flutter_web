...
const PointerDownEvent down =
    PointerDownEvent(pointer: 5, position: Offset(10.0, 10.0));

const PointerUpEvent up =
    PointerUpEvent(pointer: 5, position: Offset(11.0, 9.0));
