...
class MultiTapGestureRecognizer extends GestureRecognizer {
  ...
  void addPointer(PointerEvent event) {
    ...
    if (onTapDown != null)
      invokeCallback<void>(
          'onTapDown',
          () => onTapDown(event.pointer,
              new TapDownDetails(globalPosition: event.position)));
  }
  ...
  void _dispatchTap(int pointer, Offset globalPosition) {
    ...
    if (onTapUp != null)
      invokeCallback<void>(
          'onTapUp',
          () => onTapUp(
              pointer, new TapUpDetails(globalPosition: globalPosition)));
  ...
  void _dispatchLongTap(int pointer, Offset lastPosition) {
    ...
    if (onLongTapDown != null)
      invokeCallback<void>(
          'onLongTapDown',
          () => onLongTapDown(
              pointer, new TapDownDetails(globalPosition: lastPosition)));
  }

  @override
  void dispose() {
    final List<_TapGesture> localGestures =
        new List<_TapGesture>.from(_gestureMap.values);
