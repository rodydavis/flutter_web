...
class ThemeData extends Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Color>('accentColor', accentColor,
    ...
    properties.add(DiagnosticsProperty<Color>('cardColor', cardColor,
    ...
    properties.add(DiagnosticsProperty<Color>('hintColor', hintColor,
        defaultValue: defaultData.hintColor));
    properties.add(DiagnosticsProperty<Color>('errorColor', errorColor,
