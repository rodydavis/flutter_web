...
class CupertinoPageRoute<T> extends PageRoute<T> {
  ...
  static final Set<PageRoute<dynamic>> _popGestureInProgress =
      Set<PageRoute<dynamic>>();
  ...
  static bool _isPopGestureEnabled<T>(PageRoute<T> route) {
    ...
    if (_popGestureInProgress.contains(route)) return false;
...
class _CupertinoBackGestureController<T> {
  ...
  void _handleStatusChanged(AnimationStatus status) {
    ...
    if (status == AnimationStatus.dismissed)
      navigator.pop<
          T>(); // this will cause the route to get disposed, which will dispose us
